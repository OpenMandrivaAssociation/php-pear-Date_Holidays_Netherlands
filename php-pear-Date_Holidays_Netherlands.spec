...
install -d %{buildroot}%{_datadir}/pear/%{_class}/%{_subclass}/{Driver,Filter/%{_region}}
install %{_pearname}-%{version}/%{_subclass}/Driver/*.php %{buildroot}%{_datadir}/pear/%{_class}/%{_subclass}/Driver
install %{_pearname}-%{version}/%{_subclass}/Filter/%{_region}/*.php %{buildroot}%{_datadir}/pear/%{_class}/%{_subclass}/Filter/%{_region}
...
%dir %{_datadir}/pear/%{_class}/%{_subclass}/Filter/%{_region}
%{_datadir}/pear/%{_class}/%{_subclass}/Filter/%{_region}/*.php
